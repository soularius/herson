...
<footer id="colophon" class="site-footer" role="contentinfo">
    <div class="boxFooter bg-1 py-4 py-md-5 px-4">
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-8 col-xl-9 d-flex flex-column justify-content-around px-0">
                    <div class="row menuFooterCols">
                        <div class="col-12 col-md-4">
                            <?php
                            wp_nav_menu(array(
                                'theme_location' => 'menu-1-footer-logged',
                        ...
                        <div class="col-12 col-md-4">
                            <?php
                            wp_nav_menu(array(
                                'theme_location' => 'menu-2-footer-logged',
                                'container_class' => 'custom-footer-menu'
                            ));
                            ?>
                        </div>
                        <div class="col-12 col-md-4">
                            <?php
                            wp_nav_menu(array(
                                'theme_location' => 'menu-3-footer-logged',
                                'container_class' => 'custom-footer-menu'
                            ));
                            ?>
                        </div>
                    ...
                    <div class="row pt-5 d-none d-lg-block">
                        <div class="col">
                            ...
                            <div class="socialSites d-flex">
                                ...
                                ?><a href="<?php if (get_sub_field('url_red_social', 'option')) : the_sub_field('url_red_social', 'option');
                                            endif; ?>
