...
function createUpdateProductsStockSITE_0($id_product, $id_variation, $json, $type) {
    $point_access = get_site_url();
    $path = "wp-json/wc/v3/products/{$id_product}/variations/{$id_variation}";
...
function getAllProductsCellars_0($id_product) {
    $point_access = get_site_url();
    $path = "wp-json/wc/v3/products/{$id_product}/variations/";
    $endPoint = "{$point_access}/{$path}";
    try {
            $username = "ck_f769616ad969ace9d5436c0c94372c9dbfe7095f";
            $password = "cs_2606455099bb39940576cd0214277e3e99b0f422";
